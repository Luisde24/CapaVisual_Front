#capa visual
Importnte instalar los modulos de node para que corra ell proyecto con npm i


#CapaVisual

Este proyecto se generó con [Angular CLI](https://github.com/angular/angular-cli) versión 15.2.1.
